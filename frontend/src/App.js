...
const IMAGES = {
  ...
  dp: {
    ...
    letraM2: "https://customer-assets.emergentagent.com/job_sitio-listo-1/artifacts/np8y8vnp_8ee60643-86e6-4880-a327-679debe61608.JPG",
  }
};
      ...
      <section className="dp-sketches" data-testid="dp-sketches">
        <div className="dp-sketches-inner">
          <div className="sketches-image">
            <img src="https://customer-assets.emergentagent.com/job_sitio-listo-1/artifacts/kvqa1u68_Screenshot%202026-04-17%20at%2012.36.37%E2%80%AFp.m..png" alt="Sistema de señalética - Señales direccionales, identificación de edificio, protección civil, extintor, paso peatonal, estacionamiento, señalización, seguridad, accesibilidad" />
          </div>
        </div>
      </section>
        ...
        <div className="projects-inner">
          ...
          <div className="gallery-grid-large">
            ...
            <div className="gallery-item wide" data-testid="dp-gallery-5">
              <img src={IMAGES.dp.almacen} alt="Almacén - Señalización de racks" style={{ objectPosition: 'center 35%' }} />
              <div className="gallery-overlay" style={{ background: 'rgba(232, 57, 26, 0.65)' }}>
                <span className="gallery-category">Industrial</span>
            ...
            <div className="gallery-item" data-testid="dp-gallery-6">
              <img src={IMAGES.dp.letraM} alt="Letra volumétrica M - Nave industrial" style={{ objectPosition: 'center 30%' }} />
              <div className="gallery-overlay" style={{ background: 'rgba(232, 57, 26, 0.65)' }}>
                <span className="gallery-category">Industrial</span>
