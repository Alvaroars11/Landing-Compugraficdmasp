...
const DPSection = ({ onSwitchToCompugrafic, onContactClick }) => {
  return (
    <div className="section-transition" data-testid="dp-section">
      ...
      <section className="dp-mision-vision" data-testid="dp-mision-vision">
        <div className="dp-mv-inner">
          <div className="dp-mv-card dp-mv-mision">
            ...
            <p className="dp-mv-text">
              Transformamos espacios en experiencias intuitivas a través de soluciones 
              integrales de señalética y wayfinding donde cada diseño tiene un propósito 
              específico. Con más de 25 años de experiencia, fusionamos vanguardia y 
              expertise para crear sistemas de orientación que no solo comunican la 
              identidad de cada marca, sino que cumplen la función precisa de guiar, 
              informar y conectar. Nuestra señalética combina diseño estético con 
              propósito funcional, garantizando durabilidad y efectividad en cada pieza.
            </p>
          </div>
          <div className="dp-mv-card dp-mv-vision">
            <span className="dp-mv-label">VISIÓN</span>
            <p className="dp-mv-text">
              Ser la empresa líder en señalética y wayfinding reconocida por transformar 
              la orientación en experiencias memorables. Aspiramos a ser el socio 
              estratégico preferido para desarrolladores y marcas que buscan la simbiosis 
              perfecta entre funcionalidad, estética y proyección de identidad, 
              estableciendo conexiones significativas entre las personas y los espacios.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Sketches / Tipologías de Señalética */}
      <section className="dp-sketches" data-testid="dp-sketches">
        <div className="dp-sketches-inner">
          <span className="section-label">TIPOLOGÍAS</span>
          <h2 className="section-title-dark">Lo que diseñamos</h2>
          <p className="section-description-dark">
            Cada proyecto incluye diferentes tipologías de señalización adaptadas
          ...
          <div className="sketches-grid">
            <div className="sketch-item">
              <svg viewBox="0 0 120 140" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="20" y="10" width="80" height="100" rx="2" stroke="#3A3835" strokeWidth="1.5" strokeDasharray="4 2" opacity="0.6"/>
                <circle cx="60" cy="40" r="12" stroke="#E8391A" strokeWidth="1.5" opacity="0.7"/>
                <line x1="60" y1="52" x2="60" y2="75" stroke="#E8391A" strokeWidth="1.5" opacity="0.7"/>
                <line x1="60" y1="60" x2="48" y2="70" stroke="#E8391A" strokeWidth="1.5" opacity="0.7"/>
                <line x1="60" y1="60" x2="72" y2="70" stroke="#E8391A" strokeWidth="1.5" opacity="0.7"/>
                <line x1="60" y1="75" x2="50" y2="92" stroke="#E8391A" strokeWidth="1.5" opacity="0.7"/>
                <line x1="60" y1="75" x2="70" y2="92" stroke="#E8391A" strokeWidth="1.5" opacity="0.7"/>
                <text x="60" y="130" textAnchor="middle" fontSize="7" fill="#3A3835" fontFamily="Inter" opacity="0.5">PICTOGRAMA</text>
              </svg>
            </div>
            <div className="sketch-item">
              <svg viewBox="0 0 120 140" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="30" y="15" width="60" height="40" rx="2" stroke="#3A3835" strokeWidth="1.5" strokeDasharray="4 2" opacity="0.6"/>
                <line x1="60" y1="55" x2="60" y2="110" stroke="#3A3835" strokeWidth="2" opacity="0.5"/>
                <line x1="50" y1="110" x2="70" y2="110" stroke="#3A3835" strokeWidth="2" opacity="0.5"/>
                <polygon points="80,35 90,35 85,28" fill="#E8391A" opacity="0.6"/>
                <line x1="40" y1="35" x2="78" y2="35" stroke="#E8391A" strokeWidth="1.5" opacity="0.6"/>
                <text x="60" y="130" textAnchor="middle" fontSize="7" fill="#3A3835" fontFamily="Inter" opacity="0.5">TÓTEM</text>
              </svg>
            </div>
            <div className="sketch-item">
              <svg viewBox="0 0 120 140" fill="none" xmlns="http://www.w3.org/2000/svg">
                <line x1="60" y1="5" x2="60" y2="25" stroke="#3A3835" strokeWidth="1.5" opacity="0.5"/>
                <line x1="40" y1="5" x2="80" y2="5" stroke="#3A3835" strokeWidth="1.5" opacity="0.5"/>
                <rect x="25" y="25" width="70" height="45" rx="2" stroke="#3A3835" strokeWidth="1.5" strokeDasharray="4 2" opacity="0.6"/>
                <polygon points="80,47 88,47 84,42" fill="#E8391A" opacity="0.6"/>
                <line x1="35" y1="47" x2="78" y2="47" stroke="#E8391A" strokeWidth="1.5" opacity="0.6"/>
                <text x="60" y="130" textAnchor="middle" fontSize="7" fill="#3A3835" fontFamily="Inter" opacity="0.5">COLGANTE</text>
              </svg>
            </div>
            <div className="sketch-item">
              <svg viewBox="0 0 120 140" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="10" y="20" width="100" height="70" rx="2" stroke="#3A3835" strokeWidth="1.5" strokeDasharray="4 2" opacity="0.6"/>
                <line x1="60" y1="35" x2="60" y2="80" stroke="#3A3835" strokeWidth="0.8" opacity="0.3"/>
                <line x1="15" y1="55" x2="105" y2="55" stroke="#3A3835" strokeWidth="0.8" opacity="0.3"/>
                <circle cx="35" cy="43" r="5" stroke="#E8391A" strokeWidth="1" opacity="0.5"/>
                <rect x="45" y="38" width="20" height="3" rx="1" fill="#3A3835" opacity="0.3"/>
                <rect x="65" y="62" width="30" height="3" rx="1" fill="#E8391A" opacity="0.4"/>
                <rect x="20" y="65" width="25" height="3" rx="1" fill="#3A3835" opacity="0.3"/>
                <text x="60" y="130" textAnchor="middle" fontSize="7" fill="#3A3835" fontFamily="Inter" opacity="0.5">DIRECTORIO</text>
              </svg>
            </div>
            <div className="sketch-item">
              <svg viewBox="0 0 120 140" fill="none" xmlns="http://www.w3.org/2000/svg">
                <line x1="95" y1="10" x2="95" y2="100" stroke="#3A3835" strokeWidth="1.5" opacity="0.4"/>
                <rect x="15" y="25" width="80" height="30" rx="2" stroke="#3A3835" strokeWidth="1.5" strokeDasharray="4 2" opacity="0.6"/>
                <polygon points="25,40 33,35 33,45" fill="#E8391A" opacity="0.6"/>
                <rect x="38" y="37" width="45" height="3" rx="1" fill="#3A3835" opacity="0.3"/>
                <rect x="38" y="42" width="30" height="2" rx="1" fill="#3A3835" opacity="0.2"/>
                <text x="55" y="130" textAnchor="middle" fontSize="7" fill="#3A3835" fontFamily="Inter" opacity="0.5">BANDERA</text>
              </svg>
            </div>
            <div className="sketch-item">
              <svg viewBox="0 0 120 140" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="15" y="15" width="90" height="80" rx="2" stroke="#3A3835" strokeWidth="1.5" strokeDasharray="4 2" opacity="0.6"/>
                <circle cx="45" cy="40" r="3" fill="#E8391A" opacity="0.5"/>
                <rect x="55" y="37" width="35" height="3" rx="1" fill="#3A3835" opacity="0.3"/>
                <circle cx="45" cy="55" r="3" fill="#E8391A" opacity="0.5"/>
                <rect x="55" y="52" width="35" height="3" rx="1" fill="#3A3835" opacity="0.3"/>
                <circle cx="45" cy="70" r="3" fill="#E8391A" opacity="0.5"/>
                <rect x="55" y="67" width="35" height="3" rx="1" fill="#3A3835" opacity="0.3"/>
                <polygon points="30,80 22,84 22,76" fill="#E8391A" opacity="0.5"/>
                <polygon points="85,80 93,84 93,76" fill="#E8391A" opacity="0.5"/>
                <text x="60" y="130" textAnchor="middle" fontSize="7" fill="#3A3835" fontFamily="Inter" opacity="0.5">PROTECCIÓN CIVIL</text>
              </svg>
            </div>
            <div className="sketch-item">
              <svg viewBox="0 0 120 140" fill="none" xmlns="http://www.w3.org/2000/svg">
                <line x1="10" y1="50" x2="110" y2="50" stroke="#3A3835" strokeWidth="1" opacity="0.3"/>
                <rect x="25" y="20" width="70" height="30" rx="2" stroke="#3A3835" strokeWidth="1.5" strokeDasharray="4 2" opacity="0.6"/>
                <polygon points="82,35 90,35 86,30" fill="#E8391A" opacity="0.6"/>
                <rect x="35" y="32" width="42" height="3" rx="1" fill="#3A3835" opacity="0.3"/>
                <text x="60" y="130" textAnchor="middle" fontSize="7" fill="#3A3835" fontFamily="Inter" opacity="0.5">MURO</text>
              </svg>
            </div>
            <div className="sketch-item">
              <svg viewBox="0 0 120 140" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="20" y="10" width="80" height="90" rx="2" stroke="#3A3835" strokeWidth="1.5" strokeDasharray="4 2" opacity="0.6"/>
                <circle cx="60" cy="35" r="10" stroke="#E8391A" strokeWidth="1.5" opacity="0.6"/>
                <line x1="53" y1="35" x2="67" y2="35" stroke="#E8391A" strokeWidth="1.5" opacity="0.6"/>
                <line x1="60" y1="28" x2="60" y2="42" stroke="#E8391A" strokeWidth="1.5" opacity="0.6"/>
                <rect x="35" y="55" width="50" height="3" rx="1" fill="#3A3835" opacity="0.3"/>
                <rect x="40" y="62" width="40" height="2" rx="1" fill="#3A3835" opacity="0.2"/>
                <rect x="35" y="72" width="50" height="3" rx="1" fill="#3A3835" opacity="0.3"/>
                <rect x="40" y="79" width="40" height="2" rx="1" fill="#3A3835" opacity="0.2"/>
                <text x="60" y="130" textAnchor="middle" fontSize="7" fill="#3A3835" fontFamily="Inter" opacity="0.5">NORMATIVA</text>
              </svg>
            </div>
          </div>
        </div>
        ...
        <div className="projects-inner">
          ...
          <div className="gallery-grid-large">
            ...
            <div className="gallery-item wide" data-testid="dp-gallery-8">
              <img src={IMAGES.dp.worldHotels} alt="WorldHotels Acueducto" style={{ objectPosition: 'center 30%' }} />
              <div className="gallery-overlay" style={{ background: 'rgba(232, 57, 26, 0.65)' }}>
                <span className="gallery-category">Hotelero</span>
            ...
            <div className="gallery-item" data-testid="dp-gallery-10">
              <img src={IMAGES.dp.paloAlto} alt="Palo Alto Italoamericano" style={{ objectPosition: 'left center' }} />
              <div className="gallery-overlay" style={{ background: 'rgba(232, 57, 26, 0.65)' }}>
